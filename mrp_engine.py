"""
mrp_engine.py — Motor MRP para PostgreSQL (Supabase)
"""
...
def agregar_receta(nombre, descripcion=""):
    return _lastid("INSERT INTO recetas (nombre,descripcion) VALUES (%s,%s)",(nombre,descripcion))
...
def comparar_menus(filtro_categoria=None, filtro_racion=None, margen_pct=35, empaque=5.0):
    ...
    if filtro_categoria: sql+=" AND categoria=%s"; params.append(filtro_categoria)
    if filtro_racion:    sql+=" AND racion=%s";    params.append(filtro_racion)
